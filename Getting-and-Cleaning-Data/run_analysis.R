filesPath <- "Users/Mike/Downloads/UCI HAR Dataset"
setwd("/Users/Mike/Downloads/getdata%2Fprojectfiles%2FUCI HAR Dataset.zip")
...
# Reading "features.txt" extracting the mean and standard deviation
